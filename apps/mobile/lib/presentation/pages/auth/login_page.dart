...
class _LoginPageState extends State<LoginPage> {
  ...
  void _handleLogin(BuildContext providerContext) async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      ScaffoldMessenger.of(providerContext).showMaterialBanner(
        MaterialBanner(
          content: Text(
            provider.errorMessage ?? "An unexpected error occurred while processing your request. Please Try Again.",
            style: TextStyle(
              color: AppColors.colorOnInfo
            ),
          ),
          actions: [
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('iRemitMo Login')),
      body: SafeArea(
        child: Center(
